...
import fragmentShaderDepth from './shaders/depth.frag';
import vertexShaderDepth from './shaders/depth.vert';
...
class StaticWorld extends React.Component {
  ...
  constructor(props, context) {
    ...
    if (module.hot) {
      ...
      module.hot.accept('./shaders/depth.frag', () => {
        this.setState({
          fragmentShaderDepth: require('./shaders/depth.frag'),
        });
      });

      module.hot.accept('./shaders/depth.vert', () => {
        this.setState({
          vertexShaderDepth: require('./shaders/depth.vert'),
        });
      });
    }
  }
